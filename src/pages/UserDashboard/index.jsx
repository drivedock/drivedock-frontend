...
export const UserDashboard = () => {
 return (
  <section className="flex flex-col  h-80 p-5 w-full">
   <div className="">
    <div class="">
     <nav class="relative px-8 pb-4 flex justify-between items-center border-y border-gray-400 dark:border-gray-700">
      <ul class=" lg:flex lg:items-center lg:justify-end grow mr-4">
       <li>
        <div class="relative">
     ...
     >
      ...
      >
       ...
       <div className="absolute p-4 bottom-4 text-left">
        <h1 className="text-2xl text-green-100 font-semibold">{item.title}</h1>
