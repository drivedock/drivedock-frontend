...
function SideNavBar() {
 ...
 return (
  ...
  //    </figure>
  //   </nav>
  <aside class="flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 border rounded-md">
   <NavLink to="/">
   ...
   <div class="flex flex-col justify-between flex-1 mt-6">
    <nav class="flex-1 -mx-3 space-y-3">
     ...
     >
      ...
      <span class="mx-2 text-sm font-medium letSdisable">Home</span>
     </a>
     <a
      class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
      href="#"
     >
      ...
      <span class="mx-2 text-sm font-medium letSdisable">Dashboard</span>
     </a>
     <a
      class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
      href="#"
     >
      ...
      <span class="mx-2 text-sm font-medium letSdisable">Projects</span>
     </a>
     <a
      class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
      href="#"
     >
      ...
      <span class="mx-2 text-sm font-medium letSdisable">Users</span>
     </a>
     <a
      class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
      href="#"
     >
      ...
      <span class="mx-2 text-sm font-medium letSdisable">Setting</span>
     </a>
    </nav>
    <div class="mt-6">
     <div class="p-3 bg-gray-100 rounded-lg dark:bg-gray-800 letSdisable">
     ...
     <div class="flex items-center justify-between mt-6 flexColum">
      <a href="#" class="flex items-center gap-x-2 flexColum    ">
       <img
