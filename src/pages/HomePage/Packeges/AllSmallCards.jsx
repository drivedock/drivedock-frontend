...
function AllSmallCards() {
 return (
  ...
  //    </div>
  //   </section>
  <div class="container mx-auto px-10 md:px-0 py-10">
   ...
   <div class="mt-8">
    <div class="relative flex h-[300px] items-center justify-center rounded-[10px] md:justify-end">
     <img
      ...
      alt=""
      class="object-cover w-full h-full rounded-[10px] z-0"
     />
    </div>
    <section class="py-10">
      ...
      <div class="grid grid-cols-2 mt-8 text-center sm:mt-16 lg:mt-20 sm:grid-cols-4 gap-y-8 lg:grid-cols-9 gap-x-0">
       <div>
        <img
         ...
         alt=""
        />
        <p class="mt-8 text-lg font-semibold leading-tight text-black dark:text-white">
         Jenny Wilson
        </p>
        <p class="mt-1 text-base leading-tight text-gray-600 dark:text-gray-200">
         Founder
        </p>
       </div>
