 ...
 return (
  ...
  <section class="bg-white dark:bg-gray-900 container">
   <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
    <div class="lg:mt-0 lg:col-span-5 lg:flex md:flex-col-reverse sm:flex-col-reverse xl:flex-col-reverse flex-col-reverse">
     <img src={secondHeroSecImg} alt="hero Img" />
    </div>

    <div class="mr-auto place-self-center lg:col-span-7 ml-8">
     ...
     <a
      href="#"
      class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-green-500 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900"
     >
      Get started
      <svg
