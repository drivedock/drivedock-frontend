function Card(props) {
 ...
 return (
  <>
   ...
   <article class="overflow-hidden dark:shadow-gray-800 rounded-md py-4 border">
    <img class="w-18 h-16 m-auto" src={image} alt="Mountain" />
    <div class="px-4 py-4">
    ...
    <div class="px-6 pt-4 pb-2">
     <span class="block text-center  bg-gray-200 dark:bg-gray-800 rounded-full px-3 py-1  text-sm font-semibold text-gray-700 dark:text-gray-200 mr-2 mb-2 m-auto">
      photography
     </span>
    </div>
   </article>
