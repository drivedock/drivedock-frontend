  ...
  <footer class="container mx-auto px-10 md:px-0 py-10">
   <div class="flex items-center space-x-2">
    ...
    <div className="mt-1.5">
     <h1 class="text-xl font-bold text-black dark:text-gray-100">Drive Dock</h1>
    </div>
   </div>
   ...
   <div class="mt-8">
    <ul class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-6 lg:space-x-12 items-start md:items-center font-semibold text-base text-gray-700 dark:text-gray-100">
     <li>About us</li>
