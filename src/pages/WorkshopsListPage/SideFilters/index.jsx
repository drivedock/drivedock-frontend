...
export const SideFilters = () => {
  ...
  return (
    <section className="py-8  w-full max-h-screen  sm:py-16 lg:py-10">
          ...
          <section className="py-4 max-h-screen sm:py-16 rounded-md  overflow-auto lg:py-20 bg-gray-50 dark:bg-gray-900">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
              ...
              <div className="flex items-center justify-center lg:justify-between">
                <h2 className="text-2xl fixed z-10 w-full  font-bold text-gray-900 dark:text-white sm:text-3xl">
                  Upcoming workshops
                </h2>
              </div>
              {/* Products */}
              <div className="flex flex-wrap  overflow-auto gap-4 mt-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 sm:mt-10">
